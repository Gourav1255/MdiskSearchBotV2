...
class Config(object):
    API_ID = int(os.getenv("API_ID", "15072632"))
    API_HASH = os.getenv("API_HASH", "ca639f129f27f59f7a1045b59e3d7468")
    BOT_TOKEN = os.getenv("BOT_TOKEN", "5857390556:AAG4siv6Q7KhXHjFuzFiox0qGxfy8ava9vk")
    BOT_SESSION_NAME = os.getenv("BOT_SESSION_NAME", "sharedisk")
    USER_SESSION_STRING = os.getenv("USER_SESSION_STRING", "1BVtsOLoBu4WkfXO2dQsbeEi-t6c07-Genvz2nz8DVWwlZzoMC2a4KHvi0atJCFm-6Nq96yR_vDaMOYXp_6mAd2EtMMb5bJFfs_B0OVNOLg5xgzSR9_Rp_2aNr4NnLFDHjSxjXVW13tZZmTTHw3Q8eo1JaonXhLmXSCS1m0EX5iqr_iRqOxPdMqw4Qw9-muwbORy9IlgNuG_QJvjzgRKv2FuExR1uWePtPd2vOcd7SFEhO1v-ofunPw6pHsoD0Z07jBe8CZMzw6L3tyAE5YCGi8jFCikvGxxqFhtsjEJ-4II_NzYJz4HuzrTq-0md6PTqI-oKoBjdgCKsmV2MxS5MnPd3uP9phMs=")
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1001779312100")) 
    BOT_USERNAME = os.getenv("BOT_USERNAME", "Sharedisklinkserchbot")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "560072848"))
#    OWNER_USERNAME = os.getenv("OWNER_USERNAME", "sharmaofficial143")
    BACKUP_CHANNEL = os.getenv("BACKUP_CHANNEL", "mxplayerfreemovies")
#    GROUP_USERNAME = os.getenv("Goru Movie Zone")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    ...
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://sdisk123:sdisk123@cluster0.v28p5q3.mongodb.net/?retryWrites=true&w=majority")
...
ᴅᴍ ꜰᴏʀ ᴀɴʏ Qᴜᴇʀʏ @sharmaofficial143 🤖""" )
    ABOUT_WATCH_TEXT = """
ʜᴇʏ ʙᴜᴅᴅʏ, 
